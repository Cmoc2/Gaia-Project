...
//city nodes
var LA = {key: "LA", population: 5000, next: null,  posX: 300, posY: 100, resetPopulation: 100000/2, resistance: null, resistAmount: 150};
var BOSTON = {key: "BOSTON", population: 5000, next: LA, posX: 150, posY: 200, resetPopulation: 90000/2, resistance: null, resistAmount: 150}; //not sure if this is how you can save 'color';
var HOUSTON = {key: "HOUSTON", population: 5000, next: BOSTON, posX: 375, posY: 300, resetPopulation: 70000/2, resistance: null, resistAmount: 150}; //not sure if this is how you can save 'color';
var SF = {key: "SF", population: 5000, next: HOUSTON, posX: 290, posY: 400, resetPopulation: 90000/2, resistance: null, resistAmount: 150}; //not sure if this is how you can save 'color';
var VEGAS = {key: "VEGAS", population: 5000, next: SF, posX: 500, posY: 400, resetPopulation: 60000/2, resistance: null, resistAmount: 150}; //not sure if this is how you can save 'color';
	...
	switch(keyvalue){
		case Key_Space:
			...
			if(_screen == pause_menu) _screen = play_game;
				else if(_screen == play_game){canvas.style.cursor = 'auto'; _screen = pause_menu;}
		...
		case Key_M:
			...
			break;
		case Key_K:
			TITAN.damage=IFRIT.damage=SHIVA.damage=200000;
			break;
		case Key_Esc:
			if(_screen == pause_menu) _screen = play_game;
